...
def create_modules(module_defs):
    ...
    for i, module_def in enumerate(module_defs):
        ...
        if module_def['type'] == 'convolutional':
            ...
            modules.add_module('shortcut_%d' % i, shortcut)
...
class Darknet(nn.Module):
    ...
    # def save_weights(self,path,cutoff=-1):  # https://github.com/talebolano/yolov3-network-slimming/blob/335227f60477f7f078d2f9595a69faf7fc9541b2/yolomodel.py#L432:9
